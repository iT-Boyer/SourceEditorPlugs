...
import XcodeKit
/**
 我们将要移除Swift文件中所有闭包里面的括号。主要分以下三步：
 1. 找到包含闭包的行
 2. 从特定的行里面移除两个括号
 3. 重置被修改的行（译者注：原文是substitute back the modified line ，结合代码感觉重置比较恰当）
 http://www.iseedog.com/2016/09/21/xcode-source-editor/#more
 */
extension NSString {
